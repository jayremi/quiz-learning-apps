...
public class MathHard_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.hard_math);

        //Navigation drawer
        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        drawerLayout = findViewById(R.id.drawer_math_hard);
        navigationView = findViewById(R.id.navigationView_math_hard);
        ...
        mScoreView = (TextView) findViewById(R.id.score_mathhard);
        mQuestion = (TextView) findViewById(R.id.quiz_mathhard);
        mBt_choice1 = (Button) findViewById(R.id.a_math_hard);
        mBt_choice2 = (Button) findViewById(R.id.b_math_hard);
        mBt_choice3 = (Button) findViewById(R.id.c_math_hard);
        mBt_choice4 = (Button) findViewById(R.id.d_math_hard);
        mBt_tips=(Button)findViewById(R.id.tips_math_hard) ;
