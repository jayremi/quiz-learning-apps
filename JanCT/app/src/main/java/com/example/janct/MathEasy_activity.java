...
public class MathEasy_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.easy_math);

        //Navigation drawer
        toolbar=findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        drawerLayout=findViewById(R.id.drawer_math_easy);
        navigationView=findViewById(R.id.navigationView_math_easy);
        ...
        mScoreView=(TextView)findViewById(R.id.score_matheasy);
        mQuestion=(TextView)findViewById(R.id.quiz_matheasy);
        mBt_choice1=(Button)findViewById(R.id.a_math_easy);
        mBt_choice2=(Button)findViewById(R.id.b_math_easy);
        mBt_choice3=(Button)findViewById(R.id.c_math_easy);
        mBt_choice4=(Button)findViewById(R.id.d_math_easy);
        mBt_tips=(Button)findViewById(R.id.tips_math_easy);
